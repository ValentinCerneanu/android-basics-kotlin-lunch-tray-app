...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        if(_subtotal.value != null) {
            _subtotal.value = _subtotal!!.value!!.plus(-previousEntreePrice) //sau (-_entree.value!!.price)
        }
    ...
    fun setSide(side: String) {
        ...
        if(_subtotal.value != null){
            _subtotal.value = _subtotal!!.value!!.plus(-previousSidePrice) //sau (-_side.value!!.price)
        }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        //  accompaniment.
        if(_subtotal.value != null) {
            _subtotal.value = _subtotal!!.value!!.plus(-previousAccompanimentPrice)
        }
