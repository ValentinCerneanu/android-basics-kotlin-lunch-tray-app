...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        requireView().findNavController().navigate(R.id.action_sideMenuFragment_to_accompanimentMenuFragment)
    }
    ...
    fun cancelOrder() {
        ...
        requireView().findNavController().navigate(R.id.action_sideMenuFragment_to_startOrderFragment)
    }
