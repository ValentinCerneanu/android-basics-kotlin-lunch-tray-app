...
class EntreeMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        requireView().findNavController().navigate(R.id.action_entreeMenuFragment_to_sideMenuFragment)
    }
    ...
    fun cancelOrder() {
        ...
        requireView().findNavController().navigate(R.id.action_entreeMenuFragment_to_startOrderFragment)
    }
