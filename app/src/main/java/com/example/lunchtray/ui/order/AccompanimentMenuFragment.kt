...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        requireView().findNavController().navigate(R.id.accompanimentMenuFragment_to_checkoutFragment)
    }
    ...
    fun cancelOrder() {
        ...
        requireView().findNavController().navigate(R.id.accompanimentMenuFragment_to_startOrderFragment)
    }
